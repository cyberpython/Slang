...
import glossaeditor.ui.components.charsetselectpane.JCharsetSelectPane;
...
public class DocumentIOManager {
    ...
    private void openFile(Component parent, FileFilter filter) throws IOException {
        ...
        JCharsetSelectPane accessory = null;
        if(filter instanceof GlossaFileFilter){
            accessory = new JCharsetSelectPane();
        ...
        if (selection == JFileChooser.APPROVE_OPTION) {
            ...
            if (f != null) {
                if(accessory!=null){
                    this.charset = accessory.getSelectedCharset();
                }
