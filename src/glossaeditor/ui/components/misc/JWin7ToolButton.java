 ...
 */
public class JWin7ToolButton extends JButton implements MouseListener {
    ...
    public JWin7ToolButton() {
        super();
        init();
    }

    public JWin7ToolButton(Icon icon) {
        super(icon);
        init();
    }

    public JWin7ToolButton(String text, Icon icon) {
        super(text, icon);
        init();
    }

    public JWin7ToolButton(String text) {
        super(text);
        init();
    }
    ...
    private void paintFocused(Graphics2D g2d, int width, int height){
