 ...
 */
public class GlossaFileFilter extends FileFilter implements java.io.FileFilter{
    ...
    public boolean accept(File f){
        ...
        if( extension.equals("gls") || extension.equals("glossa")){
            return true;
        }
        return false;
    }
